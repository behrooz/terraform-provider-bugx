...
**Note**: The secret resource uses the `/api/v1/secrets` endpoint. Make sure your API base URL points to the correct server (e.g., `http://localhost:5173` for simple-vault API).
